...
class CrossStitch_ABSA(Trainer):
    """docstring for CrossStitch_ABSA"""
    ...
    def cal_cs( self , inp_l , inp_r ):
        ...
        [ left_x_2 , left_x_1 ] = self.stitch_layer([ left_x_2 , left_x_1  ])
        [ right_x_2 , right_x_1 ] = self.stitch_layer([ right_x_2 , right_x_1  ])
        ...
        if self.config['n_layers'] == 2:
            ...
            [ left_x_2 , left_x_1 ] = self.stitch_layer2([ left_x_2 , left_x_1  ])
            [ right_x_2 , right_x_1 ] = self.stitch_layer2([ right_x_2 , right_x_1  ])
...
model = CrossStitch_ABSA( exp_location="./ttt" , config_args = config )
model.train()
