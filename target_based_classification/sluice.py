...
class Sluice_ABSA(Trainer):
    ...
    def cal_cs( self , inp_l , inp_r ):
        ...
        left_x_2 = self.rnn_left_2( left_x) # prim
        right_x_2 = self.rnn_right_2( right_x )
        ...
        [ left_x_2 , left_x_1 ] = self.stich_n_disect([ left_x_2 , left_x_1  ])
        [ right_x_2 , right_x_1 ] = self.stich_n_disect([ right_x_2 , right_x_1  ])

        pleft_x_2 , pleft_x_1 = left_x_2 , left_x_1
        pright_x_2 , pright_x_1 = right_x_2 , right_x_1


        left_x_2 = self._rnn_left_2( left_x) # prim
        right_x_2 = self._rnn_right_2( right_x )


        left_x_1 = self._rnn_left_( left_x )
        right_x_1 = self._rnn_right_( right_x )

        [ left_x_2 , left_x_1 ] = self.stich_n_disect([ left_x_2 , left_x_1  ])
        [ right_x_2 , right_x_1 ] = self.stich_n_disect([ right_x_2 , right_x_1  ])

        left_x_2  = self.osel([ left_x_2 ,  pleft_x_2 ])
        right_x_2  = self.osel([ right_x_2 ,  pright_x_2 ])
        left_x_1  = self.osel([ left_x_1 ,  pleft_x_1 ])
        right_x_1  = self.osel([ right_x_1 ,  pright_x_1 ])
    ...
    def stich_n_disect(self , x):
        [ a , b ] = x
        [ a1 , a2 ] = desectOut( a )
        [ b1 , b2 ] = desectOut( b )
        [ a1 , a2 , b1 , b2 ] = self.stitch_layer( [ a1 , a2 , b1 , b2 ] )
        a = Concatenate()([  a1 , a2 ])
        b = Concatenate()([  b1 , b2 ])
...
model = Sluice_ABSA( exp_location="./ttt" , config_args = config )
model.train()
